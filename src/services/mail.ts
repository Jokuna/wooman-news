...
const MailList = MailJSON[process.env.NODE_ENV ? process.env.NODE_ENV : 'development'];
...
const mailSend = async (TodayMenu: string, TodaySchedule: string, MonthlyMenu: Array<menu>): Promise<void> => {
  // OAuth token 생성
